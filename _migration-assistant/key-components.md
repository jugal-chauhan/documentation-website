...
The target cluster is the destination cluster for an upgrade or migration. Supported targets include Amazon OpenSearch Service domains and Amazon OpenSearch Serverless collections, in addition to self-managed OpenSearch clusters.
